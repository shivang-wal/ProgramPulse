...
`;
  ...
  return html;
    ...
    titleSlide.background = { fill: colors.purple };
    
    // Add title
    titleSlide.addText('Program Pulse', {
      x: 0.5,
      y: 2,
      w: 9,
      h: 1.5,
    ...
    // Add subtitle
    titleSlide.addText('keeping a pulse on all LucyRx initiatives', {
      x: 0.5,
      y: 3.5,
      w: 9,
      h: 0.5,
    ...
    // Add project count
    titleSlide.addText(`${projects.length} Active Project${projects.length !== 1 ? 's' : ''}`, {
      x: 0.5,
      y: 5.5,
      w: 9,
      h: 0.5,
    ...
    projects.forEach((project, index) => {
      ...
      // Project number and total
      slide.addText(`Project ${index + 1} of ${projects.length}`, {
        x: 0.3,
        y: 0.15,
        w: 3,
        h: 0.5,
      ...
      // Project Name
      slide.addText(project.name || 'Unnamed Project', {
        x: 0.5,
        y: 1.2,
        w: 9,
        h: 0.7,
      ...
      slide.addText(project.status || 'On Track', {
        x: 0.5,
        y: 2.05,
        w: 1.5,
        h: 0.3,
      ...
      if (project.completedThisWeek) {
        ...
        slide.addText('COMPLETED THIS WEEK', {
          x: 0.7,
          y: yPos + 0.1,
          w: 8.6,
          h: 0.3,
        ...
        slide.addText(project.completedThisWeek, {
          x: 0.7,
          y: yPos + 0.45,
          w: 8.6,
          h: 'auto',
      ...
      if (project.escalation && project.escalation !== 'None') {
        ...
        slide.addText(project.escalation, {
          x: 0.7,
          y: yPos + 0.45,
          w: 8.6,
          h: 'auto',
      ...
      if (project.plannedNextWeek) {
        ...
        slide.addText('PLANNED NEXT WEEK', {
          x: 0.7,
          y: yPos + 0.1,
          w: 8.6,
          h: 0.3,
        ...
        slide.addText(project.plannedNextWeek, {
          x: 0.7,
          y: yPos + 0.45,
          w: 8.6,
          h: 'auto',
      ...
      if (totalBugs > 0) {
        slide.addText('BUG SEVERITY MATRIX', {
          x: 0.5,
          y: yPos,
          w: 9,
          h: 0.3,
        ...
        const bugData = [
          { label: 'Critical', count: bugs.critical, color: 'dc2626' },
          { label: 'High', count: bugs.high, color: 'f59e0b' },
          { label: 'Medium', count: bugs.medium, color: '3b82f6' },
          { label: 'Low', count: bugs.low, color: '10b981' }
        ];
        ...
        bugData.forEach(bug => {
          slide.addShape(pres.ShapeType.roundRect, {
            ...
            w: 2,
            h: 0.6,
            fill: { color: bug.color }
          });
          
          slide.addText(bug.label, {
            x: xPos + 0.1,
            y: yPos + 0.08,
            w: 1.8,
            h: 0.22,
          ...
          slide.addText(bug.count.toString(), {
            x: xPos + 0.1,
            y: yPos + 0.32,
            w: 1.8,
            h: 0.22,
      ...
      // Footer
      slide.addText('Generated by Program Pulse', {
        x: 0.5,
        y: 7.0,
        w: 9,
        h: 0.3,
